...
try {
    ...
    #$postParams = @{profile_id="123"} # should be existing profile_id
    #Invoke-WebRequest -Uri "http://$($dockerMachineIp):8080/v1/data_profiles/get_profile" -Method POST -Body $postParams
